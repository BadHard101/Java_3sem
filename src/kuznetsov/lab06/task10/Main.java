...
public class Main {
    public static Computer enterComputer(Scanner in){
        ...
        Brand brand;
        int cost;
        System.out.print("enter brand (corsair / asus): ");
        switch (in.nextLine()) {
            case "corsair":
                brand = Brand.corsair;
                break;
        ...
        System.out.print("enter processor clockspeed: ");
        processor = new Processor(in.nextInt());

        System.out.print("enter computer cost: ");
        cost = in.nextInt();
    ...
    public static void main(String[] args) {
        ...
        while (command.equals("new")) {
            ...
            shop.addComputer(Main.enterComputer(in));
        ...
        while (command.equals("find") || command.equals("delete")) {
            if (command.equals("find")){
                System.out.println(shop.findComputer(Main.enterComputer(in)));
            }
            else {
                shop.deleteComputer(Main.enterComputer(in));
